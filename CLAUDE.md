...
- `app.js` - 主逻辑
- `style.css` - Liquid Glass 样式
- `data/dictionary.json` - 汉字数据

**技术栈**：
- HanziWriter 3.5（笔顺动画、笔画数据）
- 纯 JavaScript，无框架
- localStorage 存储生字本
...
- 解读内容（实务要点、案例分析）
- 关键词标签（便于搜索）
- 重要性标记（high: 43条, medium: 31条, low: 25条）

**UI 设计**：
- Liquid Glass 风格，蓝色主题（体现法规正式感）
- 浮动 orb 背景动画
...
6. 监管机构（第 51-59 条）
7. 合作与一致性（第 60-76 条）
8. 救济、责任和处罚（第 77-84 条）
9. 特定处理情形（第 85-91 条）
10. 授权法案和实施法案（第 92-93 条）
11. 最终条款（第 94-99 条）
